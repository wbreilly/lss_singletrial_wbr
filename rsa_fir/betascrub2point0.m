function bad=betascrub2point0(betas,gmmask,varargin)
...
%   Made ptile version by WBR 5_1_18
...
% removed nans this way because FIR model...
betas(isnan(betas)) = 0; 
abszbetas=abs(zscore(betas,1,4));
...
% find the threshold above which trials should be labeled bad. 
% This is slected in findbadbetas.m as 'thresh'
threshold = prctile(zmeans,threshold);
