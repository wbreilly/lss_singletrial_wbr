function userOptions = defineUserOptions(curSubj)
%
...
userOptions.analysisName = sprintf('%s_FIR_RSA_10_31_18',curSubj);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	userOptions.maskPath = '/Users/wbr/walter/fmri/sms_scan_analyses/data_for_spm/ants_from_clust_10_23_18/[[subjectName]]/mprage_sag_NS_g3/[[maskName]]';
%     userOptions.maskPath = '/Users/wbr/walter/fmri/sms_scan_analyses/data_for_spm/glass_10_20_18/[[subjectName]]/masks/[[maskName]]';
...
%                'rh_PCC' 'rh_PHG' 'rh_Prec' 'rh_RSC' 'rh_TPole' 'rh_VMPFC' 'rh_occ_pole'};
            ...
            % 6_28_19 just ANTS rois. I apparently deleted the masks
            % folder. FS rois exist in  freesurfer_done_10_22_18
...
%         load('glassroinames359.mat');
% %         load('glass_roi_names.mat');
%         userOptions.maskNames = z(2:end);
...
userOptions.subjectNames = cellstr(curSubj);
