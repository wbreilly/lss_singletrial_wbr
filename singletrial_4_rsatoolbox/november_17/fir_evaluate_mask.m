...
load('/Users/wbr/walter/fmri/sms_scan_analyses/rsa_singletrial/singletrial_4_rsatoolbox/RDMs/.mat');

% load mask
load('masks_32reg_FIR.mat')
%path to bad betas
bad_beta_path = '/Users/wbr/walter/fmri/sms_scan_analyses/data_for_spm/';
...
for ipos = 1:32
    ...
    for iRDM = 1:size(RDMs,2)
        ...
        beta_txt = fullfile(bad_beta_path,subjects{iRDM}, '', 'samepos_tmap_5ptile_10_27.txt');
